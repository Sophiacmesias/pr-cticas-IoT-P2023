...
// wifi credentials
const char *ssid = "hess"; // Tu SSID
const char *password = "hess1234"; // Tu PWD del SSID
WiFiClient client;

// OpenWeather
String apiTemperature;
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=20.6069&lon=-103.415629&appid=30ebd6e2f3a7bb7d0c9b18c41d722731&units=metric"; //El path que usaste en el web para la tem de la API - TODO el path con http

// ThingSpeak
// set a twittwer
String tweet = "Proyecto IoT, mensaje AUTOMATICO - La temperatura actual en mi ciudad es: " +
apiTemperature + "*C";
ThingSpeak.setTwitterTweet("sophiamesias", tweet); // sustituir por el nombre de tu usuario de twitter
uint32_t channelNumber = 2066054; // Tu channel ID number de thingspeak
const char *writeAPIKey = "OP24ZKEKT5SO7S74"; // El API write de thingspeak
