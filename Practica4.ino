...
#define TOKEN "BBFF-tHoyuXfv8vfChz2g5eiZTnAC4raTqE" // Ubidots TOKEN name el mismo que usamos en clase
...
#define DEVICE_LABEL "servicio" // Nombre del dispositivo a crear
